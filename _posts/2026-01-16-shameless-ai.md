...
* **Prevent Agent Laziness (Shortcuts):** I’ve started explicitly instructing my agents to "unblock themselves." If a dependency is missing, install it. If a test fails, fix it and move on. Don't take shortcuts by implementing "hacky" or poor solutions. 
