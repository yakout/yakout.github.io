...
Note: this summary serves as a fast refresh of information only, and not as a study material.
...
- Data augmentation
- Early Stopping
- Parameters tying and sharing  Dropout
...
- **Is perfect reconstruction good?**
  ...
  - So we avoid overtraining by enforcing the network to learn only import features.
- Two types of AE:
...
- Parameters tying between encoder $(W)$ and decoder $(W^T)$
  - Why transpose? منك لله يا مايكل ._.
